...
class ImageViewController: UIViewController {
    ...
    override func loadView() {
        ...
        // OR destroy timer when it finish loading
    ...
    override func viewDidLoad() {
        ...
        //		let original = UIImage(named: image)! // IOS load the img and out it into an image cache for later reuse. its sometimes helpful but not in this scenario and adds memory pressure.
        //        MARK: Redo:
